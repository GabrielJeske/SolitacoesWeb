...
class _ConsultaState extends State<Consulta> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async{
      ...
      // 1. Abre o loading UMA única vez
      Uteis.openDialog(); 
      
      // 2. Faz as duas requisições no servidor tranquilamente
      ApiResponse resp =  await usuarioMob.obtemListaAcessos();         
      ApiResponse respU = await usuarioMob.obtemUsuarios();
      
      // 3. Fecha o loading com segurança
      Uteis.closeDialog();       
      
     
      if (!resp.sucesso){                
        Uteis.showSnack(titulo: "Falha Acessos", mensagem: resp.mensagem, isErro: true);
      }
      
      if (!respU.sucesso){
        Uteis.showSnack(titulo: "Falha Usuários", mensagem: respU.mensagem, isErro: true);
      }
