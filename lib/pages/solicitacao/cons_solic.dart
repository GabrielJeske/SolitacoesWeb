...
class ConsultaSolic extends StatefulWidget {
  const ConsultaSolic({super.key});

  @override
  State<ConsultaSolic> createState() => _ConsultaSolicState();
}

class _ConsultaSolicState extends State<ConsultaSolic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "Consulta de Solicitações"),
